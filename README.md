...
- Enterprise RAG Knowledge Assistant (In Progress)
- WhatsApp Lead Follow-up AI Agent (In Progress)
...
### 📂 Featured Project
#### AI Review Management Automation System
- Automated customer review monitoring
- Sentiment analysis
- Instant notifications for negative reviews
- Human-in-the-loop approval system
- Built with n8n + OpenAI API + Telegram
